...
즉, b는 최대 30정도가 될 수 있다는 것이고
 ...
 x는 1,2 가 아니라 최소 3이라는 점에서 ( 왜 ?? 2 ^ b와 별개의 숫자에 대한 연산이라고 한다면, 
 1은, ^ a 해줘봤자, 1만 되고, 2는 이미 2 ^ b 형태로 계산을 고려하기 때문에
 최소 3인 b 라는 숫자에 대한 고민을 시작하게 되는 것이다 
)
그냥 2^30 ~~ 10억이니까

3^a 인 a에 대해서도 30정도라고 setting 해도 될 것이다 
